            ...
            <div className='items-center flex flex-col space-y-8 lg:grid lg:grid-cols-2 pt-12 lg:space-y-0 lg:gap-8 text-gray-700 lg:items-center md:items-center sm:items-center' >
                ...
                <div className='flex flex-col w-11/12 items-center border sm:grid sm:grid-flow-col sm:grid-cols-2 sm:cols  rounded-xl'>
                    ...
                    <div>
                        <div className=''>
                            <h1 className='font-semibold text-2xl p-4 pb-2 pt-2'>France Experience</h1>
                            <p className='flex w-full justify-between p-4 pt-0 pb-0'>10 days <span className='flex relative'>4.5 <AiTwotoneStar className="absolute bottom-1 right-8 text-orange-500" /> <span className='pl-6'> (80)</span></span></p>
                            <p className='p-4 pb-0 text-sm'>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore.</p>
                            <p className='p-4 pt-2'>From <span className='font-semibold'>$1,412</span></p>
                        </div>
                        <hr className='border' />
