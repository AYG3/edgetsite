    ...
    <div>
      ...
      <div className='bg-gray-100 items-center justify-center grid h-60'>
        ...
        <span className='text-2xl text-center'>
          <a href="/Home">Home </a>{'\u00BB'}<span> Login</span>
        </span>
      </div>
          ...
          <form action="POST" className='p-6 wee'>
            <div className='grid'>
              ...
              <span className='text-gray-500 flex justify-between items-center p-2'>
                ...
                <p className='text-gray-800'><a href="/ForgotPassword">Forgot Password?</a></p>
              </span>
              ...
              <p className='text-center text-gray-500 m-4'>Don't have an account? <a className='text-gray-900' href="/Register">Create One</a></p>
            </div>
          </form>
        </div>
      </div>
